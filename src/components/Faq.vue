...
<template>
  <section id="faq" class="text-center w-full bg-base-100 flex flex-col justify-center items-center gap-5 min-h-[700px] h-auto py-10 px-10 z-0">
    <h2 class="text-5xl text-secondary-content font-extrabold font-title pb-2">{{ $props.t.faq }}</h2>
